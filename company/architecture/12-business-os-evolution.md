...
*not* flag Operations/Finance/Design, which share one head). 11 tests, including
assertions against the live roadmap. **Deferred to Phase 1a** (need capability
KPI/domain metadata the model doesn't yet carry): "distinct capability success
metric" and "operational-sector ownership floor" — stubbed as no-ops, not faked.
